...
namespace MusicFree
{
    ...
    {   
        ...
        public DbSet<MusicianUser> musician_likes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MusicianView>().HasOne(b => b.author).WithMany(a => a.listened_by).HasForeignKey(b => b.MusicianId);
